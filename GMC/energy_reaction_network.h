    ...
    double energy_budget)
{
    ...
    // Update the propensities for reactions corresponding to species
    // which were produced or consumed
    ...
    // We'll need to update the propensities for all reactions which have
    // a dG > energy_budget
